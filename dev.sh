...
newtab -G coffee-stir -wv -o intermediate/main000.coffee main000.coffee

newtab -G coffee -cbmw --output build intermediate

newtab -G coffee -cbmw --output build/workers workers
